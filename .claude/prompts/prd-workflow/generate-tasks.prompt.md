...
**IMPORTANT**: All generated tasks MUST follow the rules defined in `.claude/task-workflow.md`, including:
...
All levels use the same subdirectory pattern: `architecture/`, `implementation/`, `setup/`, `testing/`. See `.claude/documentation-organization.md` for complete rules.
...
**Key Requirements** (per task-workflow.md):
