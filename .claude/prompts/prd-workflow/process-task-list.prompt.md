...
Make sure to follow the rules in `.claude/task-workflow.md`.

## Before Starting (per task-workflow.md)

1. **Read TASKS.md** - Find the current task, review acceptance criteria and dependencies
2. **Read design.md** - Understand architecture and design decisions
3. **Discover related docs** - Use `file_search` with `docs/**/*.md` to find completion summaries
