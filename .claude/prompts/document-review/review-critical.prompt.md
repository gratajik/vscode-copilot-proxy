...
- [[thinking_question_knowledge]] - Need to understand question-oriented methodology before critically assessing its implementation

### Related Topics

- [[thinking_first_principles]] - Critical assessment validates whether work applies first principles reasoning by checking for unexamined assumptions
- [[prompt_socratic_interlocutor]] - Both use systematic questioning to identify weaknesses and strengthen arguments
- [[thinking_question_decomposition]] - Critical assessment validates decomposition quality through MECE and synthesis tests
- [[thinking_reverse_questions]] - Both analyze existing work structure, though reverse questions extracts implicit architecture while critical assessment evaluates quality
- [[thinking_systems]] - Critical assessment can validate systems thinking application by checking for overlooked interdependencies and feedback loops
- [[thinking_verify_references]] - Reference verification is part of evidence quality assessment dimension in critical framework
- [[criticism_traditional_analysis]] - Traditional critical analysis shares systematic, evidence-based evaluation methodology
- [[criticism_film_traditional]] - Applies critical assessment framework to cinema-specific formal elements

### Extends

- [[thinking_question_knowledge]] - Provides evaluation framework for question-oriented methodology quality
